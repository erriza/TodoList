...
//! Se comenta para integrar moongose
// const items = ["Buy Food", "Cook Food", "Eat Food"];
// const workItems = [];

mongoose.set('strictQuery', false);

mongoose.connect("mongodb+srv://admin-erick:Test123@cluster0.6qfcajm.mongodb.net/todolistDB", {useNewUrlParser: true});
    ...
    if (foundItems.length === 0) {
      Item.insertMany(defaultItems, (err) => {
        if(err){
          ...
          console.log("Pushed default data to DB");
        }
      });
      res.redirect("/");
    } else {
